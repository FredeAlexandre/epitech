...
NibblerParts::NibblerParts(int coordX, int coordY, std::shared_ptr<NibblerParts> next, bool isHead)
{
...
NibblerParts::~NibblerParts()
{
}

std::list<int> NibblerParts::get_Coord()
{
    return _coords;
}

std::list<int> NibblerParts::prev_get_Coord()
{
    return _prevCoords;
}

void NibblerParts::checkRotationHead()
{
...
int NibblerParts::moveCoord(int x, int y)
{
    if (_next == nullptr) {
        _prevCoords = _coords;
...
void NibblerParts::actualiseCoord()
{
