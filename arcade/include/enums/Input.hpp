...
#ifndef _ARCADE_ENUMS_INPUT_
    #define _ARCADE_ENUMS_INPUT_
...
namespace arcade {
    namespace enums {
        enum Input {
            ...
            H, I, J, K, L, M, N, O, P, Q,
            R, S, T, U, V, W, X, Y, Z, Num0,
            Num1, Num2, Num3, Num4, Num5,
            Num6, Num7, Num8, Num9, Escape,
            ...
            BackSpace, Tab, PageUp, PageDown, End,
            Home, Insert, Delete, Add, Subtract,
            Multiply, Divide, Left, Right, Up,
